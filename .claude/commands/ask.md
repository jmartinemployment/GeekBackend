...
1. If $ARGUMENTS contains architecture/flow/trace/how/explain → codebase-memory-mcp + graphify
2. If $ARGUMENTS contains find/search/locate/where/what file → cocoindex
3. If $ARGUMENTS contains safe/impact/blast/breaks/risk/change/affect → code-review-graph
