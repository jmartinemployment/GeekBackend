...
/// </summary>
public sealed class GccPoliteCrawler : IGccPoliteCrawler
{
    private readonly HttpClient _http;
    private readonly GccPoliteHostRegistry _registry;
    private readonly TimeProvider _clock;
    private readonly ILogger<GccPoliteCrawler> _logger;
    ...
    public GccPoliteCrawler(
        HttpClient http,
        GccPoliteHostRegistry registry,
        TimeProvider clock,
        ILogger<GccPoliteCrawler> logger,
    ...
    public async Task<GccPoliteFetchResult> GetHtmlAsync(Uri url, CancellationToken cancellationToken = default)
    {
        ...
        return await controller.ExecutePolitelyAsync(async () =>
        {
            ...
            if (robots is not null && !robots.IsAllowedAccess(url, _userAgent))
            {
                ...
                return new GccPoliteFetchResult(GccPoliteFetchResult.Statuses.BlockedByRobots, null);
            }
            ...
            try
            {
                ...
                if (response.StatusCode is HttpStatusCode.TooManyRequests or HttpStatusCode.ServiceUnavailable)
                {
                    ...
                    return new GccPoliteFetchResult(GccPoliteFetchResult.Statuses.RateLimited, null);
                }
                ...
                if (!response.IsSuccessStatusCode)
                {
                    ...
                    return new GccPoliteFetchResult(GccPoliteFetchResult.Statuses.HttpError, null);
                }
                    ...
                    && !media.Contains("xml", StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    controller.MarkRequestCompleted(chosenDelay, _clock);
                    return new GccPoliteFetchResult(GccPoliteFetchResult.Statuses.ContentTypeSkipped, null);
                }
                ...
                if (string.IsNullOrWhiteSpace(html))
                {
                    ...
                    return new GccPoliteFetchResult(GccPoliteFetchResult.Statuses.EmptyBody, null);
                }

                return new GccPoliteFetchResult(GccPoliteFetchResult.Statuses.Success, html);
            }
            ...
            catch (Exception ex)
            {
                ...
                controller.MarkRequestCompleted(chosenDelay, _clock);
                return new GccPoliteFetchResult(GccPoliteFetchResult.Statuses.RequestFailed, null);
            }
