...
public sealed class GccV2WriteService
{
    ...
    /// <summary>
    /// Serializes the in-progress document for the writer as JSON. A paragraph boundary is an
    /// explicit field here, never inferred from a blank line, so it can't turn into whitespace or
    /// have its nesting flatten outright the way a flat-text hop would.
    /// </summary>
