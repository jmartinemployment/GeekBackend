// ============================================================================================
// CUSTOM AGENT STUDIO - COMMENTED OUT, NOT DELETED.
//
// Studio is owner-scoped "durable drafts over task-agent versions". It has no UI surface in
// content-creator-v2 (zero references), so nothing reaches these endpoints today. Kept because
// it is the natural place to build specific agents that pull specific information out of RAG,
// if and when that work happens.
//
// Still live and intentionally untouched:
//   - GccV2StudioLlmExecutor / GccV2StudioTemplateRenderer / GccV2StudioEvaluator (TaskAgents/)
//     plus their unit tests, so the pieces do not rot while the API is parked.
//   - LmStudioController / LmStudioProvider - unrelated. That is LM Studio, the local model
//     provider, and it is the configured DefaultProvider. Do not confuse the two names.
//
// To revive: delete the "// " prefix from every line below this header.
// ============================================================================================
