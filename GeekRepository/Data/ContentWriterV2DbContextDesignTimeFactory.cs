...
public class ContentWriterV2DbContextDesignTimeFactory : IDesignTimeDbContextFactory<ContentWriterV2DbContext>
{
    public ContentWriterV2DbContext CreateDbContext(string[] args)
    {
        ...
        var options = new DbContextOptionsBuilder<ContentWriterV2DbContext>()
            .UseNpgsql(connectionString)
            .ConfigureWarnings(w => w.Ignore(RelationalEventId.PendingModelChangesWarning))
            .Options;

        return new ContentWriterV2DbContext(options);
    }
