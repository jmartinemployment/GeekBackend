...
[Migration("20260912010000_AddSharePointConnections")]
public partial class AddSharePointConnections : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            name: "gcc_v2_sharepoint_connections",
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_gcc_v2_sharepoint_connections", x => x.Id);
            });

        migrationBuilder.CreateIndex(
            name: "IX_gcc_v2_sharepoint_connections_OwnerUserId",
            schema: "content_creator_v2",
            table: "gcc_v2_sharepoint_connections",
            column: "OwnerUserId");

        migrationBuilder.CreateIndex(
            name: "IX_gcc_v2_sharepoint_connections_OwnerUserId_AccountLabel",
            schema: "content_creator_v2",
            table: "gcc_v2_sharepoint_connections",
