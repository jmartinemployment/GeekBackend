...
public class GeekCrawlerDbContextDesignTimeFactory : IDesignTimeDbContextFactory<GeekCrawlerDbContext>
{
    public GeekCrawlerDbContext CreateDbContext(string[] args)
    {
        ...
        return new GeekCrawlerDbContext(options);
    }
