...
public interface IContentGenerator
{
    ...
    /// ContentDocument/Section/Paragraph/Run schema (lib/types.ts) — not free-text prose. This is
    /// the shape the frontend actually renders; <see cref="GenerateDraftAsync"/>'s unstructured
    /// output cannot be rendered into it. Returns the validated JSON string, ready to store as a
